...
laser = pygame.image.load('lazer.png')
beam = pygame.image.load('beam.png')
shieldImage = pygame.image.load('shield.png')
beamDrop = pygame.image.load('beamDrop.png')
minigunDrop = pygame.image.load('minigunDrop.png')
enemy1 = pygame.image.load('enemy.png')
enemyBall = pygame.image.load('enemyBall.png')
